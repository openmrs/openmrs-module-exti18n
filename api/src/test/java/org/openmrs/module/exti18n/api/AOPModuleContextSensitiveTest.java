...
/**
 * Extend this class to run context sensitive tests that should load an AOP
 * {@link MethodInterceptor}.
 */
public abstract class AOPModuleContextSensitiveTest extends BaseModuleContextSensitiveTest implements TestWithAOP {
