...
public class AddressValuesHibernateInterceptorTest extends I18nBaseModuleContextSensitiveTest {
	...
	@Test
	@Verifies(value = "should save the i18n locaton coming from a location set in a specific locale", method = "onSave(Object entity, Serializable id, Object[] state, String[] propertyNames, Type[] types)")
